      ...
      <Card className="border-0 shadow-sm">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-lg">חשבונית ירוקה (???????)</CardTitle>
              <CardDescription>חיבור למערכת חשבונית ירוקה להנפקת חשבוניות אוטומטית</CardDescription>
            </div>
            <a
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="api_key">???? API</Label>
            <Input
              id="api_key"
              type="password"
              value={apiKey}
          ...
          <div className="space-y-2">
            <Label htmlFor="api_secret">??? API</Label>
            <Input
              id="api_secret"
              type="password"
              value={apiSecret}
      ...
      <Card className="border-0 shadow-sm bg-blue-50 border-blue-200">
        <CardContent className="p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• בסיום עבודה, לחץ על "הוצא חשבונית" בפרטי העבודה</li>
            <li>• המערכת תיצור חשבונית אוטומטית בחשבונית ירוקה</li>
            <li>• פרטי הלקוח והעבודה יועברו אוטומטית</li>
            <li>• תוכל לעקוב אחר סטטוס התשלום במערכת</li>
          </ul>
        </CardContent>
      </Card>
    </div>
